...
- Voice input starts with one tap, streams editable text into the composer, and stops with a second tap. It requires a native Yoda Mobile development or production build; Expo Go users can use the system keyboard microphone.
