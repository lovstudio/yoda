...
function rowToAgent(row: AgentRow): Agent {
  ...
  return {
    ...
    modelSuffix: row.modelSuffix ?? null,
...
function sanitizeDraft(draft: AgentDraft): Omit<AgentDraft, 'name'> & { name: string } {
  ...
  return {
    ...
    modelSuffix: draft.modelSuffix?.trim() ? draft.modelSuffix.trim() : null,
    ...
    return this.create(
      {
        ...
        model: source.model,
        modelSuffix: source.modelSuffix,
