...
export const MaasView: React.FC<{
  ...
  const handleAddPlatform = useCallback((platformId: MaasPlatformId) => {
            ...
            action={
              <div className="flex flex-wrap items-center justify-end gap-2">
                <Badge variant="secondary">
                  {t('maas.addedCount', { count: configuredCount })}
                </Badge>
                  ...
                  <DropdownMenuTrigger
                    render={
                      <Button
                        ...
                        variant="outline"
                        size="sm"
                        disabled={isLoading || availablePlatformIds.length === 0}
                      >
      ...
      <AccordionPrimitive.Header className="flex items-center gap-1 pr-2.5">
        ...
        {onCancelDraft && (
          <Tooltip>
            <TooltipTrigger
              render={
                <Button
                  ...
                  variant="ghost"
                  size="icon-xs"
                  aria-label={t('maas.cancelAddPlatform', { platform: platform.name })}
            ...
            />
            <TooltipContent>
              {t('maas.cancelAddPlatform', { platform: platform.name })}
            </TooltipContent>
          </Tooltip>
        )}
        <Tooltip>
