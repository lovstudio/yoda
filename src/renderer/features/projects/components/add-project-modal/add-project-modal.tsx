        ...
        <div className="flex items-center gap-2">
          ...
          >
            <Tooltip>
              ...
              />
              <TooltipContent>{t('home.localMode')}</TooltipContent>
            </Tooltip>
            <Tooltip>
              <TooltipTrigger
                render={
