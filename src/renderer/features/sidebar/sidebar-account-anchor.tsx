  ...
  return (
    <div className="flex min-w-0 flex-1 items-center text-foreground-tertiary-muted">
      <button
        ...
        className="flex min-w-0 flex-1 items-center gap-2 rounded-md px-1.5 py-1.5 text-left transition-colors hover:bg-background-tertiary-1 hover:text-foreground-tertiary focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring"
      ...
      >
        {user?.avatarUrl ? (
          ...
          <span className="flex size-7 shrink-0 items-center justify-center rounded-full bg-background-tertiary-2">
            <CircleUserRound className="size-4" />
          </span>
        )}
        <span className="min-w-0 flex-1 truncate text-xs font-medium leading-4 text-foreground-tertiary">
          {displayName}
        </span>
      </button>
      <SidebarHelpMenu />
